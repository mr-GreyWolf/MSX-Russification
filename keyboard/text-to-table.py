...
if __name__=='__main__':
	if len(sys.argv)==3:
		...
		# фрагменты (адрес, длина) для MSX 1 и 2
		fragment=[["DA5",288],["1033",40]]
	elif len(sys.argv)==4 and sys.argv[3]=='2+':
		file_i=sys.argv[1] # исходный файл
		file_o=sys.argv[2] # файл с таблицей
		# фрагменты (адрес, длина) для MSX 2+
		fragment=[["DA5",288],["0FF8",40]]
	else:
...
def hex_to_symbol(hex):
	hex_name={
		'00':'NULL','01':'GRAPH','02':'CTRL+B','03':'CTRL+C','04':'CTRL+D','05':'CTRL+E','06':'CTRL+F',
		'07':'BEEP','08':'BS','09':'TAB','0a':'LF','0b':'HOME','0c':'CLS','0d':'RET','0e':'CTRL+N',
		'0f':'CTRL+O','10':'CTRL+P','11':'CTRL+Q','12':'INS','13':'CTRL+S','14':'CTRL+T','15':'CTRL+U',
		'16':'CTRL+V','17':'CTRL+W','18':'SEL','19':'CTRL+Y','1a':'CTRL+Z','1b':'ESC',
		'1c':'Right','1d':'Left','1e':'Up','1f':'Down','20':'SPC','7f':'DEL'
	}
	if hex in hex_name:
