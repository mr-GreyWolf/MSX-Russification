...
Отличия таблиц `MSX_1.txt` и `MSX_2.txt` минимальны. Для MSX 1 отсутствуют коды для клавиш:
```
0x48 2A
0x49 2B
0x4A 2F
...
### MSX.txt
Исправленная таблица. Цифры, точка и запятая нажимаются в нижнем регистре — без SHIFT.
